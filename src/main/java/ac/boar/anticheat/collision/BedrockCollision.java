...
public class BedrockCollision {
    ...
    public static List<Box> getCollisionBox(final BoarPlayer player, final Vector3i vector3i, final BlockState state) {
        // Fence state is calculated by Bedrock client sided.
        // Also I couldn't just calculate the new block state id and use BlockUtils.getCollision() since the logic for it that Geyser implemented is wrong
        // TODO: Make my own implementation so I won't have to do this mess?
        // Prob the most retarded code I ever seen.
        if (player.getSession().getTagCache().is(BlockTag.FENCES, state.block())) {
            BlockUtil.FenceState fenceState = BlockUtil.findFenceBlockState(player, vector3i);

            if (fenceState.east() && fenceState.north() && fenceState.west() && fenceState.south()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.375f), new Box(0.375f, 0.0f, 0.625f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.east() && fenceState.north() && fenceState.south()) {
                return List.of(new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 1.0f), new Box(0.625f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f));
            }

            if (fenceState.east() && fenceState.north() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.375f), new Box(0.375f, 0.0f, 0.625f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.east() && fenceState.south() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.625f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.north() && fenceState.south() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 0.625f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.375f), new Box(0.375f, 0.0f, 0.625f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.east() && fenceState.north()) {
                return List.of(new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.625f), new Box(0.625f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f));
            }

            if (fenceState.east() && fenceState.south()) {
                return List.of(new Box(0.375f, 0.0f, 0.375f, 0.625f, 1.5f, 1.0f), new Box(0.625f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f));
            }

            if (fenceState.east() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f));
            }

            if (fenceState.north() && fenceState.south()) {
                return List.of(new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.north() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 0.625f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.375f));
            }

            if (fenceState.south() && fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 0.625f, 1.5f, 0.625f), new Box(0.375f, 0.0f, 0.625f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.east()) {
                return List.of(new Box(0.375f, 0.0f, 0.375f, 1.0f, 1.5f, 0.625f));
            }

            if (fenceState.north()) {
                return List.of(new Box(0.375f, 0.0f, 0.0f, 0.625f, 1.5f, 0.625f));
            }

            if (fenceState.south()) {
                return List.of(new Box(0.375f, 0.0f, 0.375f, 0.625f, 1.5f, 1.0f));
            }

            if (fenceState.west()) {
                return List.of(new Box(0.0f, 0.0f, 0.375f, 0.625f, 1.5f, 0.625f));
            }

            return List.of(new Box(0.375f, 0.0f, 0.375f, 0.625f, 1.5f, 0.625f));
        }
